/**
 * Created by zzpzero on 2018/1/5.
 */
/*!
...
!function (e, t) {
    ...
    return function (e) {
        ...
        var a = n(1), o = i(a), r = n(7), u = i(r), l = n(8), d = i(l), f = n(9), s = i(f), c = n(11), p = i(c), v = n(13), h = i(v), m = n(15), _ = i(m), y = n(17), w = i(y), g = n(18), b = i(g), k = n(19), x = i(k), j = n(20), E = i(j), C = n(24), M = n(29), S = i(M), O = n(31), P = i(O);
        t.default = {
            dialog: o.default,
            alert: u.default,
            confirm: d.default,
        ...
        function a() {
            ...
            t = r.default.extend({
                ...
                content: "",
                className: "",
                buttons: [{label: "纭畾", type: "primary", onClick: r.default.noop}],
                isAndroid: n
            }, t);
            var i = (0, r.default)(r.default.render(l.default, t)), a = i.find(".weui-dialog"), o = i.find(".weui-mask");
            return (0, r.default)("body").append(i), o.addClass("weui-animate-fade-in"), a.addClass("weui-animate-fade-in"), i.on("click", ".weui-dialog__btn", function (n) {
                var i = this, a = (0, r.default)(this).index();
                e(function () {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(6), l = i(u), d = void 0;
        ...
        function a() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments[1], n = arguments[2], i = "object" === ("undefined" == typeof t ? "undefined" : o(t));
            return i && (n = t), n = u.default.extend({
                content: e,
                buttons: [{label: "纭畾", type: "primary", onClick: i ? u.default.noop : t}]
            }, n), (0, d.default)(n)
        }
        ...
        function a() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments[1], n = arguments[2], i = arguments[3], a = "object" === ("undefined" == typeof t ? "undefined" : o(t));
            return a && (i = t), i = u.default.extend({
                content: e,
                buttons: [{label: "鍙栨秷", type: "default", onClick: a ? u.default.noop : n}, {
                    label: "纭畾",
                    type: "primary",
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(10), l = i(u), d = void 0;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a() {
            ...
            if (d)return d;
            n = r.default.extend({content: t, className: ""}, n);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(12), l = i(u), d = void 0;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a() {
            ...
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            if (d)return d;
            var a = r.default.os.android;
            i = r.default.extend({menus: t, actions: n, className: "", isAndroid: a}, i);
            var o = (0, r.default)(r.default.render(l.default, i)), u = o.find(".weui-actionsheet"), f = o.find(".weui-mask");
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(14), l = i(u), d = void 0;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a(e) {
            ...
            "number" == typeof n && (n = {duration: n}), "function" == typeof n && (n = {callback: n}), n = r.default.extend({
                content: e,
                duration: 3e3,
                callback: r.default.noop,
                className: ""
            ...
            var i = (0, r.default)(r.default.render(l.default, n));
            return (0, r.default)("body").append(i), d && (clearTimeout(d.timeout), d.hide()), d = {hide: t}, d.timeout = setTimeout(t, n.duration), i[0].hide = t, i[0]
        }

        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(16), l = i(u), d = null;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a(e) {
            ...
            return t.forEach(function (e) {
                ...
                var n = (0, r.default)(e), i = n.find(".weui-search-bar__label"), a = n.find(".weui-search-bar__input"), o = n.find(".weui-icon-clear"), u = n.find(".weui-search-bar__cancel-btn");
                i.on("click", function () {
        ...
        function a(e) {
            ...
            return t = r.default.extend({defaultIndex: 0, onChange: r.default.noop}, t), n.forEach(function (e) {
                var n = (0, r.default)(e), i = n.find(".weui-navbar__item, .weui-tabbar__item"), a = n.find(".weui-tab__content");
        ...
        function o(e, t, n) {
            ...
            if ("INPUT" == i.tagName || "TEXTAREA" == i.tagName) {
                ...
                var f = function () {
                    var e = t.find('input[type="checkbox"][name="' + i.name + '"]'), n = o.replace(/[{\s}]/g, "").split(","), a = 0;
        ...
        function r(e) {
            if (e) {
                var t = (0, s.default)(e.ele), n = e.msg, i = t.attr(n + "Tips") || t.attr("tips") || t.attr("placeholder");
        ...
        function u(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s.default.noop, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = (0, s.default)(e);
            return i.forEach(function (e) {
                var i = (0, s.default)(e), a = i.find("[required]");
                "function" != typeof t && (t = r);
                for (var u = 0, l = a.length; u < l; ++u) {
                    var d = a.eq(u), f = o(d, i, n.regexp), c = {ele: d[0], msg: f};
        ...
        function l(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = (0, s.default)(e);
        ...
        var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        }, f = n(2), s = i(f), c = n(15), p = i(c);
        t.default = {validate: u, checkIfBlur: l}, e.exports = t.default
    }, function (e, t, n) {
        "use strict";
        function i(e) {
            return e && e.__esModule ? e : {default: e}
        ...
        function a(e, t) {
            ...
            t = r.default.extend({
                ...
                t.onBeforeQueued = function (t, n) {
                    ...
                    if (i === !1)return !1;
                    if (i !== !0) {
                        var a = (0, r.default)(r.default.render(l.default, {id: t.id}));
                ...
                t.onQueued = function (n) {
                    if (!e.call(n)) {
                        ...
                        a.css({backgroundImage: 'url("' + (n.base64 || n.url) + '")'}), t.auto || i(o, n.id)
                    }
                }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(21), l = i(u), d = n(22), f = n(23), s = i(f), c = 0;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a(e, t, a) {
            ...
            o.onload = function (o) {
                ...
                var r = new Image;
                r.onload = function () {
                    var o = n(r), u = document.createElement("canvas"), l = u.getContext("2d"), d = t.compress.width, f = t.compress.height, s = r.width, c = r.height, p = void 0;
                    if (s < c && c > f ? (s = parseInt(f * r.width / r.height), c = f) : s >= c && s > d && (c = parseInt(d * r.height / r.width), s = d), u.width = s, u.height = c, l.drawImage(r, 0, 0, s, c / o), p = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? u.toDataURL("image/jpeg", t.compress.quality) : u.toDataURL(e.type), "file" == t.type)if (/;base64,null/.test(p) || /;base64,$/.test(p))a(e); else {
                        var v = i(p);
        ...
        "use strict";
        function n(e) {
            var t = e.url, n = e.file, i = e.fileVal, a = e.onBeforeSend, o = e.onProgress, r = e.onError, u = e.onSuccess, l = n.name, d = n.type, f = n.lastModifiedDate, s = {
                name: l,
                type: d,
            ...
            if (a(n, s, c) !== !1) {
                o(n, 0);
                var p = new FormData, v = new XMLHttpRequest;
        ...
        function o() {
            function e(n, i) {
                ...
                d.find(".weui-picker__group").eq(i).scroll({
                    items: n, temp: u[i], onChange: function (n, a) {
            ...
            var a = arguments[arguments.length - 1], o = l.default.extend({
                id: "default",
                className: "",
            ...
            for (var t = l.default.extend({
                ...
                for (var u = 0; u < 12; u++) {
                    for (var d = [], f = 1; f < i[u] + 1; f++) {
                        var s = {label: f + "鏃�", value: f};
                        d.push(s)
                    }
                    r.push({label: u + 1 + "鏈�", value: u + 1, children: d})
                }
                var c = {label: a + "骞�", value: a, children: r};
                n.push(c)
            }
            return o(n, t)
        }
        ...
        var u = n(2), l = a(u);
        n(25);
        var d = n(26), f = i(d), s = n(27), c = a(s), p = n(28), v = a(p), h = void 0, m = function (e) {
            e && (e.remove(), h = !1)
        }, _ = function (e) {
        ...
        t.default = {picker: o, datePicker: r}, e.exports = t.default
    }, function (e, t, n) {
        "use strict";
        function i(e) {
            return e && e.__esModule ? e : {default: e}
        ...
        var a = n(2), o = i(a), r = function (e, t) {
        ...
        o.default.fn.scroll = function (e) {
            ...
            var a = (0, o.default)(this).find(n.scrollable), c = void 0, p = void 0, v = void 0, h = void 0, m = [], _ = window.innerHeight;
            ...
            a = (0, o.default)(this).offAll().on("touchstart", function (e) {
                ...
                if (t - v > 100)g(Math.abs(p - c) > 10 ? p - c : i - p); else if (Math.abs(p - c) > 10) {
                    ...
                    if (o !== a) {
                        var u = m[a], l = m[o], d = u.time - l.time, f = u.y - l.y, s = f / d, h = 150 * s + (p - c);
                        g(h)
                    } else g(0)
                } else g(i - p)
            }).find(n.scrollable)
        ...
        function a(e) {
            ...
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            if (d)return d;
            n = r.default.extend({className: "", onDelete: r.default.noop}, n);
            var i = (0, r.default)(r.default.render(l.default, r.default.extend({url: e}, n)));
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = n(2), r = i(o), u = n(30), l = i(u), d = void 0;
        t.default = a, e.exports = t.default
    }, function (e, t) {
        ...
        function a(e) {
            ...
            return n.forEach(function (e) {
                ...
                function i(n) {
                    ...
                    t.step && (n = Math.round(n / p) * p), i = s + n, i = i < 0 ? 0 : i > d ? d : i, a = 100 * i / d, u.css({width: a + "%"}), l.css({left: a + "%"}), t.onChange.call(e, a)
                }

                var a = (0, r.default)(e), o = a.find(".weui-slider__inner"), u = a.find(".weui-slider__track"), l = a.find(".weui-slider__handler"), d = parseInt(r.default.getStyle(o[0], "width")), f = o[0].offsetLeft, s = 0, c = 0, p = void 0;
