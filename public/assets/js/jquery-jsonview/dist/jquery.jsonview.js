...
(function(jQuery) {
  ...
  Collapser = (function() {
    ...
    Collapser.bindEvent = function(item, options) {
      ...
      collapser.className = options.collapsed ? 'collapser collapsed' : 'collapser';
    ...
    Collapser.expand = function(collapser) {
      ...
      return collapser.className = 'collapser';//.innerHTML = '-';
    };
    ...
    Collapser.collapse = function(collapser) {
      ...
      return collapser.className = 'collapser collapsed';//.innerHTML = '+';
    };
